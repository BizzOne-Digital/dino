    ...
    <div className="min-h-screen bg-cream">
      <header className="border-b border-beige/50 bg-white">
        <div className="mx-auto flex max-w-3xl items-center gap-4 px-4 py-4">
          ...
          <h1 className="font-display text-xl font-bold text-forest">Terms & Conditions</h1>
        </div>
      </header>
      <article className="mx-auto max-w-3xl px-4 py-10">
        {content ? (
          ...
          <div className="rounded-2xl bg-white p-8 shadow-sm text-center">
            <p className="text-charcoal/60 mb-4">Terms & conditions have not been configured yet.</p>
